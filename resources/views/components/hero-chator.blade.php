...
<section id="chator" class="px-[22px] py-[26px] text-center border-b border-hair bg-cream">
    <div class="flex items-center justify-center gap-2.5 mb-[18px]">
        <span class="font-bold text-[19px] tracking-tight text-ink">Chator AI</span>
        <span class="text-[7px] text-muted">Powered by mataGen.ai</span>
    </div>
